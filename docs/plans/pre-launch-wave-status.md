...
**Last updated:** 2026-05-14 23:13 (cron iter — W6.28 second-pass reconcile; flipped W1.2, W5.25, W5.26, W5.27 to done; split W2.5–W2.17 into per-sub-item rows; confirmed X5f auto-revert #827 still draft so X5f is live on main)
...
| W2.9 (X5e) | CSV import (CommSec / Stake / Selfwealth / NABTrade / IBKR) | B | partial | #819 | CommSec parser shipped; other brokers stubbed under `lib/holdings/csv-import/` — needs parser fills + UI per broker |
