...
**Last updated:** 2026-05-17 23:20 (cron iter — W2.9 fixes (PR #873) merged; W2.17 premium content gating in-flight)
...
| W2.9 (X5e) | CSV import (CommSec / Stake / Selfwealth / NABTrade / IBKR) | B | ✅ done | #819 + #851 + #873 | CommSec (#819), Stake/SelfWealth/NABTrade/IBKR (#851), and the three Codex landing-correctness fixes (FX cost-basis, IBKR slug `interactive-brokers`, ASX digit-ticker regex `^[A-Z][A-Z0-9]{2,4}$`) all merged via #873 as commit 65640ada on 2026-05-17. Non-AUD trades are blocked at parse time with a "FX conversion temporarily unsupported" error until a per-currency AUD rate source ships |
