...
| --- | --- | --- | --- | --- |
| A | `claude/audit-remediation/a-03-batch-5-revenue-products` (#449) · `a-05-batch1-agent-ops-rls` (#451) · `a-05-batch2-ops-rls` (#452) · `a-05-batch3-crm-rls` (#453) · `a-disc-finance-monthly-view` (#454) · `a-06-batch2-broker-marketplace` (#456) · `a-06-batch3-fee-content-rls` (#457) · `a-03-batch6-consultations-courses` (#461) · `a-03-batch6-supplement-fir` (#462) · `a-03-batch7-content-tables` (#463) · `a-03-batch8-audit-qa` (#465) · `a-91-92-marketplace-notify-auth` (#545) | all prior PRs MERGED · #449/#451/#452/#453/#454/#456/#457/#461/#462/#463/#465 OPEN · **#545 OPEN** (A-91+A-92) | iter 259 — `acd61c4` (PR #545: A-91 service-role key removed from notify auth; A-92 new admin-gated campaign-notify route + 7 tests); CI pending | A-01 done. A-02 complete (batches 1-6). A-03 batches 1-8 in-progress (#351/#401/#413/#415/#417/#449/#461/#462/#463/#465). A-04 done (PR #399). A-05 batches 1-3 in-progress (#451/#452/#453). A-DISC-20260501-01 done (#454). **A-06 COMPLETE**. A-07 false-positive. A-91+A-92 in-progress (#545). Remaining A: A-05 remaining ops batches · A-93+A-94 (requireCronAuth migration) · A-99 false-positive sweep · A-DISC-20260504-01/02 (admin marketplace pages with same broken notify pattern). |
