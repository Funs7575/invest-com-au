...
| --- | --- | --- | --- | --- |
| A | `claude/audit-remediation/a-03-batch-5-revenue-products` (#449) · `a-05-batch1-agent-ops-rls` (#451) · `a-05-batch2-ops-rls` (#452) · `a-05-batch3-crm-rls` (#453) · `a-disc-finance-monthly-view` (#454) · `a-06-batch2-broker-marketplace` (#456) · `a-06-batch3-fee-content-rls` (#457) · `a-03-batch6-consultations-courses` (#461) · `a-03-batch6-supplement-fir` (#462) · `a-03-batch7-content-tables` (#463) · `a-03-batch8-audit-qa` (#465) · `a-91-92-marketplace-notify-auth` (#545) · `a-93-require-cron-auth` (#548) · `a-94-auth-hardening` (#550) · `a-disc-marketplace-notify-fix` (#552) | all prior PRs MERGED · #449/#451/#452/#453/#454/#456/#457/#461/#462/#463/#465 OPEN · **#545/#548/#550/#552 OPEN** | iter 262 — `74f4f1b` (PR #552: A-DISC-01+02 intelligence/support pages fixed); CI pending. iter 261 — `35668e4` (PR #550); CI pending. iter 260 — `e44a597` (PR #548); CI pending. iter 259 — `acd61c4` (PR #545); CI pending. | A-91+A-92 in-progress (#545). A-93 (#548). A-94 (#550). A-DISC-01+02 (#552). Remaining A: A-05 remaining ops batches. AUD-100 shard complete. |
