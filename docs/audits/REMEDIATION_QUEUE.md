...
| C | `claude/audit-remediation/c-01-admin-callgraph` (#327) · `c-03-admin-import-comments` (#360 parallel-agent) · `c-04-c-05` (#394) · `c-05b-quarterly-reports` (#349 parallel-agent) | #327 MERGED 2026-05-01T13:19Z · #360 OPEN · #394 OPEN (CI-rescue: merged main ff0480c) · #349 OPEN | last pushed 2026-05-01T21:31Z (#394) | C-01..C-08 done (merged via #303 + #327). C-DISC-20260501-01 pending (iter 166 discovery). C-03 in-progress on #360 (parallel-agent, founder unblocked Option A). C-04 done — PR #394 commit `e202d0d` (exception comment added, admin retained). C-05 (ArticleBrokerTable) done — PR #394 commit `e202d0d` (switched to createClient). C-05b in-progress on #349 (parallel-agent — quarterly_reports refactor). CI-rescue: merged `origin/main` into `c-05b-quarterly-reports` (17 commits) → merge commit `0540a608` pushed 2026-05-01; CI re-run pending. C-03 CI-rescue: merged `origin/main` (13 commits) → merge commit `71ae9da0` pushed 2026-05-01; CI re-run pending. |
