...
| EE | `claude/audit-remediation/ee-01-error-boundaries` · **#653 OPEN** | **#653 OPEN** (EE-01) | EE-01 done + EE-02/03/04 FP. Fixes quiz/calculators/savings-calc error.tsx. EE-05 done (iter 326 — E2E regression tests, commit `1da6416`). **Stream complete.** | EE-05 merged |
| FF | `claude/audit-remediation/ff-01-feature-flag-audit` · **#656 OPEN** | **#656 OPEN** (FF-01..FF-04) | FF-01 done. FF-02 done (iter 329). FF-03 false-positive (UI pre-existed W-07 commit `6723b24`). FF-04 done (iter 330 — `last_evaluated_at` column + fire-and-forget in loadFlag(), commit `aa34e77`). **Stream complete.** | FF-04 merged |
