...
| L | `claude/audit-remediation/l-observability` | #289 (draft) | pending — pushed 2026-04-30T (iter 140, L-12b batch 3) | L-06 done (commit `12183619`) — 8 SLOs seeded. L-07 done (commit `824366e`) — email alert sink + 25 tests. L-08 done (commit `832feed3`) — 6 new PostHog events + 22 tests. L-09 done (commit `153cce4`) — posthog.identify at signup+login + 17 tests. L-10 false-positive. L-11 done (commit `d588fbfb`) — WebVitals beacon. L-12a done (commit `20f5e6c`) — setLoggerUser in 12 consumer routes. L-12b batch 1 done (commit `86d4387`) — 9 routes. L-12b batch 2 done (commit `e95df16`) — 10 routes. L-12b batch 3 done (commit `5dfbdbb`) — 10 routes (article-reactions, advisor-outreach, advisor-welcome, advisor-portal/marketplace-analytics, consultation/bookings, review-incentive GET+POST, sync-shortlist GET+POST, broker-outreach, community/moderate, questions/[id]/answer). 41 routes total now tagged; ~39 remaining. |
...
| L-12b | in-progress | Wire `setLoggerUser()` in remaining ~39 routes (marketplace/*, admin/*, advisor-auth/disputes+request-review, etc.) | ~1 | P2. Remainder of L-12. 81 routes total need wiring; 12 done in L-12a + 9 done in batch 1 (iter 138, commit `86d4387`) + 10 done in batch 2 (iter 139, commit `e95df16`) + 10 done in batch 3 (iter 140, commit `5dfbdbb`): article-reactions, advisor-outreach, advisor-welcome, advisor-portal/marketplace-analytics, consultation/bookings, review-incentive, sync-shortlist, broker-outreach, community/moderate, questions/[id]/answer. 41 routes total now tagged; ~39 remaining. |
