...
| CC-02 | ~~false-positive~~ | ~~NZ supply-threshold tuning (current thresholds too aggressive)~~ | — | `lib/country-mode/supply-thresholds.ts`: `PER_COUNTRY_THRESHOLDS = { NZ: { experts: 1 } }` already implemented (PR #676). Verified iters 338-339. |
