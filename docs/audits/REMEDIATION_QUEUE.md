...
| L | `claude/audit-remediation/l-observability` | #289 (draft) | pending — pushed 2026-04-30T (iter 139, L-12b batch 2) | L-06 done (commit `12183619`) — 8 SLOs seeded. L-07 done (commit `824366e`) — email alert sink + 25 tests. L-08 done (commit `832feed3`) — 6 new PostHog events + 22 tests. L-09 done (commit `153cce4`) — posthog.identify at signup+login + 17 tests. L-10 false-positive. L-11 done (commit `d588fbfb`) — WebVitals beacon. L-12a done (commit `20f5e6c`) — setLoggerUser in 12 consumer routes. L-12b batch 1 done (commit `86d4387`) — 9 routes (advisor-auth/notifications+topup, account/export-data+delete+claim-anonymous+bookmarks, stripe/create-portal+cancel+refund). L-12b batch 2 done (commit `e95df16`) — 10 routes (fee-profile, community/posts/[id]+threads/[id], consultation/book, course/purchase+progress, referrals, advisor-auction+bid, saved-comparisons/[id]). 31 routes total now tagged; ~49 remaining. |
...
| L-12b | in-progress | Wire `setLoggerUser()` in remaining ~49 routes (account/*, advisor-auth/*, stripe/*, marketplace/*, reviews/*, etc.) | ~1 | P2. Remainder of L-12. 81 routes total need wiring; 12 done in L-12a + 9 done in batch 1 (iter 138, commit `86d4387`): advisor-auth/notifications+topup, account/export-data+delete+claim-anonymous+bookmarks, stripe/create-portal+cancel+refund. + 10 done in batch 2 (iter 139, commit `e95df16`): fee-profile, community/posts/[id]+threads/[id], consultation/book, course/purchase+progress, referrals, advisor-auction+bid, saved-comparisons/[id]. 31 routes total now tagged; ~49 remaining. |
