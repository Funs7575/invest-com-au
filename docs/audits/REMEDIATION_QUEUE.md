...
| R-COVERAGE-12..N | pending | One iteration per remaining hot module until M1 (30% overall) hit | ~29 | Scout + queue more items per iteration as the loop discovers new gaps. |
