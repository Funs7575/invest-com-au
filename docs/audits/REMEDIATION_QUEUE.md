...
- **Outcome (iter 530):** CI STILL FAILING. Lint/Build job 77484166440 failed even after merge-with-main. Root cause was not just branch divergence — something in the branch content causes the build to fail. Second merge + investigation in iter 530.
- **STATUS: PROGRESS · stream=RESCUE · item=#1171-ci-rescue · pr=#1171**
