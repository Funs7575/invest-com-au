...
| L-12b | in-progress | Wire `setLoggerUser()` in remaining ~23 routes (admin/automation/*, admin/bd-pipeline, admin/competitors, etc.) | ~1 | P2. Remainder of L-12. 80 routes with getUser; 57 tagged so far: 12 (L-12a) + 9 (b1) + 10 (b2) + 10 (b3) + 6 (b4) + 10 (b5/ad9928e: admin/advisor-applications+advisor-moderation+ai-chat, advisor-auction/public-bids, marketplace/setup-payment-method+wallet-adjust+wallet-topup+invoice/[id], questions/moderate, switch-story/moderate). ~23 remaining (mostly admin/automation/*, admin/bd-pipeline, admin/competitors, admin/fee-queue, broker-portal/*, quotes/qa, reviews/verify-client, seed, stripe/create-checkout, user-review/moderate). ~4 routes use internal helpers without user object (advisor-articles, marketplace-settings, analytics-dashboard, broker-portal/deals) — may need refactor or skip. |
