...
| --- | --- | --- | --- | --- |
| A | _not started_ | — | — | — |
| B | `claude/audit-remediation/b-07-rls-migration-lint` | #286 (draft) | pending — pushed 2026-04-30T (iter 149, B-08) | PR #220 merged (B-01..B-06 done/blocked/FP). B-07 done (`0097159`) — CI gate: new CREATE TABLE migrations must include ENABLE ROW LEVEL SECURITY. B-08 done (`204b4da`) — listings/submit + enquire counter → admin client; investment_listings anon SELECT-only migration. |
