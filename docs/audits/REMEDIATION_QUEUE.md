...
| L | `claude/audit-remediation/l-observability` | #289 (draft) | pending — pushed 2026-04-30T (iter 143, L-12b batch 6) | L-06 done (commit `12183619`) — 8 SLOs seeded. L-07 done (commit `824366e`) — email alert sink + 25 tests. L-08 done (commit `832feed3`) — 6 new PostHog events + 22 tests. L-09 done (commit `153cce4`) — posthog.identify at signup+login + 17 tests. L-10 false-positive. L-11 done (commit `d588fbfb`) — WebVitals beacon. L-12a done (commit `20f5e6c`) — 12 routes. L-12b batch 1 (`86d4387`) — 9 routes. L-12b batch 2 (`e95df16`) — 10 routes. L-12b batch 3 (`5dfbdbb`) — 10 routes. L-12b batch 4 (`15b6832c`) — 6 net-new routes. L-12b batch 5 (`ad9928e`) — 10 routes (admin/advisor-applications+advisor-moderation+ai-chat, advisor-auction/public-bids, marketplace/setup-payment-method+wallet-adjust+wallet-topup+invoice/[id], questions/moderate, switch-story/moderate). L-12b batch 6 (`b4ce2f8`) — 8 routes (advisor-articles, advisor-auth/firm+member+invite+analytics+seat-request, advisor-auth/payment, stripe/create-checkout). 65 routes total now tagged; ~16 remaining. |
...
| L-12b | in-progress | Wire `setLoggerUser()` in remaining ~16 routes (admin/automation/*, admin/bd-pipeline, admin/competitors, etc.) | ~1 | P2. Remainder of L-12. 80 routes with getUser; 65 tagged so far: 12 (L-12a) + 9 (b1) + 10 (b2) + 10 (b3) + 6 (b4) + 10 (b5/ad9928e) + 8 (b6/b4ce2f8: advisor-articles, advisor-auth/firm+member+invite+analytics+seat-request, advisor-auth/payment, stripe/create-checkout). ~16 remaining (admin/automation/*, admin/bd-pipeline, admin/competitors, admin/fee-queue, broker-portal/*, quotes/qa, reviews/verify-client, user-review/moderate). ~3 routes may be internal-only (marketplace-settings, analytics-dashboard, broker-portal/deals). |
