...
| FF | `claude/audit-remediation/ff-01-feature-flag-audit` · **#656 OPEN** | **#656 OPEN** (FF-01/02) | FF-01 done — seeded 8 missing flags. FF-02 done (iter 329). FF-02 CI rescue (iter 330 — removed unused vi.hoisted vars from test, commit `2b869f91`). FF-03/04 pending. | FF-04 merged |
