...
| CMP | `claude/audit-remediation/cmp-dq-05-raw-rankings` | **#775 OPEN** (CMP-DQ-05) | CMP-DQ-05: **#775 OPEN** (iter 361, commit `28f454e`; ?raw=1 sponsorship-boost opt-out on /best pages; boostFeaturedPartner raw param + searchParams wiring + toggle UI + 4 tests). | All CMP tasks merged |
