...
| L-12b | in-progress | Wire `setLoggerUser()` in remaining ~14 routes (admin/foreign-investment/*, admin/notify-price-change, admin/regulatory-impacts, admin/review-moderation, admin/verify, broker-portal/*, quotes/qa, reviews/verify-client, seed, user-review/moderate) | ~1 | P2. Remainder of L-12. 80 routes with getUser; 75 tagged. Batch 7 (`d88ca44`): admin/automation/bulk+config+dry-run+kill-switch+override+trigger, bd-pipeline, competitors, fee-queue, fin-objection/[id]. ~14 remaining; ~4 routes have internal helpers without user object (marketplace-settings, analytics-dashboard, broker-portal/deals, broker-portal/invoices/pdf — may need refactor or skip). |
