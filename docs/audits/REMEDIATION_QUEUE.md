...
| --- | --- | --- | --- | --- |
| A | `claude/audit-remediation/a-03-batch-5-revenue-products` (#449) · `a-05-batch1-agent-ops-rls` (#451) · `a-05-batch2-ops-rls` (#452) · `a-05-batch3-crm-rls` (#453) · `a-disc-finance-monthly-view` (#454) · `a-06-batch2-broker-marketplace` (#456) | all prior PRs MERGED · #449 OPEN · #451 OPEN · #452 OPEN · #453 OPEN · #454 OPEN · #456 OPEN | iter 204 — `5ebed84e` (PR #456: A-06 batch 2 — RLS on 6 broker marketplace tables: broker_health_scores, broker_data_changes, broker_packages, broker_review_stats, broker_review_invites, broker_activity_log); CI pending | A-01 done (PR #308). A-02 complete (batches 1-6 done). A-03 batches 1-5 done (#351/#401/#413/#415/#417/#449). A-04 done (PR #399). A-05 batches 1-3 in-progress (#451/#452/#453). A-DISC-20260501-01 done (PR #454). A-06 batch 1 done (PR #412). A-06 batch 2 in-progress (#456). A-06 ~1 batch pending. A-07 false-positive (covered by I-02, PR #353). |
...
| A-06 | in-progress | Backfill remaining miscellaneous tables | ~10 | Batch 1 done in PR #412 — 5 portfolio tables (user_portfolios, portfolio_alerts, portfolio_calculations, portfolio_fee_snapshots, portfolio_holdings). Critical: user_portfolios + portfolio_alerts had policies from 20260309/20260310 that were dead letters (ENABLE RLS never run). Batch 2 done in PR #456 — 6 broker marketplace tables (broker_health_scores, broker_data_changes, broker_packages, broker_review_stats, broker_review_invites, broker_activity_log). Discovery: admin intelligence page needs createAdminClient() for broker_activity_log — X-DISC-20260502-01. ~1 batch pending (fee/content/consultations family: fee_auto_rules, fee_update_queue, fee_profiles, regulatory_alerts, legal_documents, consultations, consultation_bookings, courses, course_lessons, course_progress). |
