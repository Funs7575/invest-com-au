...
| --- | --- | --- | --- | --- |
| A | `claude/audit-remediation/a-03-batch-5-revenue-products` (#449) · `a-05-batch1-agent-ops-rls` (#451) · `a-05-batch2-ops-rls` (#452) · `a-05-batch3-crm-rls` (#453) · `a-disc-finance-monthly-view` (#454) · `a-06-batch2-broker-marketplace` (#456) · `a-06-batch3-fee-content-rls` (#457) · `a-03-batch6-consultations-courses` (#461) · `a-03-batch6-supplement-fir` (#462) · `a-03-batch7-content-tables` (#463) · `a-03-batch8-audit-qa` (#465) · `a-91-92-marketplace-notify-auth` (#545) · `a-93-require-cron-auth` (#548) | all prior PRs MERGED · #449/#451/#452/#453/#454/#456/#457/#461/#462/#463/#465 OPEN · **#545 OPEN** (A-91+A-92) · **#548 OPEN** (A-93) | iter 260 — `e44a597` (PR #548: A-93 3 routes migrated to requireCronAuth; 11 auth tests); CI pending. iter 259 — `acd61c4` (PR #545); CI pending. | A-01 done. A-02 complete (batches 1-6). A-03 batches 1-8 in-progress. A-04 done (PR #399). A-05 batches 1-3 in-progress. A-DISC-20260501-01 done (#454). **A-06 COMPLETE**. A-07 false-positive. A-91+A-92 in-progress (#545). A-93 in-progress (#548). Remaining A: A-05 remaining ops batches · A-94 (requireCronAuth for non-admin routes) · A-DISC-20260504-01/02 (admin marketplace broken notify). |
