...
| F | `claude/audit-remediation/f-08-cache-drift` · `claude/audit-remediation/f-disc-20260510-hygiene` | #212/#305/#341/#370/#384/#457/#470/#543 · **#741 OPEN** | F-01..F-07 done. F-08 blocked (see Blocked). F-DISC-01 done (#741, commit `c41702a`). F-DISC-02..07 false-positives. CI rescue (iter 348): driftallowlist + regen for business_accounts/investor_goals. CI rescue (iter 350): driftallowlist `ab99ae1` adds listing_owner_accounts+property_holdings; CI re-running on #741. | F-08 unblocked + merged |
