...
| E | `claude/audit-remediation/e-02-batch-5-zod-rollout` (#469) · `e-02-batch-*-zod-rollout` (#460) · `e-03-zod-lint-rule` (#313) · `e-04-zod-backfill-batch-1` (#528) | #295/#313/#315/#323/#406 MERGED · #460/#469 OPEN · #528 OPEN | iter 250 CI-rescue — `ef7b95f` (fix ab-track field-specific error messages: /test_id/i, /variant/i, /event_type/i tests were failing against generic "Invalid request body"). iter 248 CI-rescue — `d40c92c` (restore pre-Zod test contracts: track-event/nps/attribution-touch). | E-01 done (PR #295 — withValidatedBody helper). E-02 in-progress (batches 1+2 MERGED PR #315/#323; batch 3 MERGED PR #406; batch 4 open PR #460; batch 5 open PR #469). E-03 done (PR #313 — ESLint rule). E-04 in-progress (#528 batch 2: 12/25 flagged routes migrated; CI rescue landed `d40c92c`). |
