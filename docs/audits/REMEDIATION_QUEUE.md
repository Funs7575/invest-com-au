...
| L | `claude/audit-remediation/l-observability` | #289 (draft) | pending — pushed 2026-04-30T (iter 144b, L-12b batch 7b) | L-06 done (commit `12183619`) — 8 SLOs seeded. L-07 done (commit `824366e`) — email alert sink + 25 tests. L-08 done (commit `832feed3`) — 6 new PostHog events + 22 tests. L-09 done (commit `153cce4`) — posthog.identify at signup+login + 17 tests. L-10 false-positive. L-11 done (commit `d588fbfb`) — WebVitals beacon. L-12a done (commit `20f5e6c`) — 12 routes. L-12b batches 1-6: 63 more routes. L-12b batch 7 (`d88ca44`): 10 admin routes (automation/*, bd-pipeline, competitors, fee-queue, fin-objection/[id]). L-12b batch 7b (`eee5f1f5`): lib/require-admin.ts (covers 19 shared-helper routes: advisor-kyc, article-comments+preview-tokens+scorecard+templates+editor, automation/flags, cohort/refresh, commodity-hubs+news-briefs, content/batch-generate, feature-flags, financial-periods, mfa/enroll+verify, reports/afsl-monthly+idr-annual, sponsored-placements, tmds) + 5 direct (advisor-dashboard, marketplace-settings, broker-portal/deals, reviews/verify-client, user-review/moderate). ~17 routes remain per grep analysis. |
...
| L-12b | in-progress | Wire `setLoggerUser()` in remaining ~17 routes | ~1 | P2. Remainder of L-12. Batch 7b (`eee5f1f5`): lib/require-admin.ts covers 19 shared-helper routes + 5 direct. ~17 remaining: admin/automation/dry-run+kill-switch+trigger, admin/fin-objection/[id] (flagged as done in parallel batch), admin/foreign-investment/update+verify, admin/notify-price-change, admin/regulatory-impacts, admin/review-moderation, admin/verify, advisor-photo, analytics-dashboard, broker-portal/invoices/[id]/pdf, cron/cleanup, quotes/[slug]/qa, seed, stripe/create-contract. |
...
- Next item: L-12b batch 8 (~17 remaining: admin/automation/dry-run+kill-switch+trigger, foreign-investment/*, notify-price-change, regulatory-impacts, review-moderation, verify, advisor-photo, analytics-dashboard, broker-portal/invoices/pdf, cron/cleanup, quotes/qa, seed, stripe/create-contract)
