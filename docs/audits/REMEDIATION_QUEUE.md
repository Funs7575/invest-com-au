...
| --- | --- | --- | --- | --- |
| A | `claude/audit-remediation/a-03-batch-5-revenue-products` (#449) · `a-05-batch1-agent-ops-rls` (#451) · `a-05-batch2-ops-rls` (#452) · `a-05-batch3-crm-rls` (#453) · `a-disc-finance-monthly-view` (#454) · `a-06-batch2-broker-marketplace` (#456) · `a-06-batch3-fee-content-rls` (#457) · `a-03-batch6-consultations-courses` (#461) · `a-03-batch6-supplement-fir` (#462) · `a-03-batch7-content-tables` (#463) · `a-03-batch8-audit-qa` (#465) · `a-91-92-marketplace-notify-auth` (#545) · `a-93-require-cron-auth` (#548) · `a-94-auth-hardening` (#550) | all prior PRs MERGED · #449/#451/#452/#453/#454/#456/#457/#461/#462/#463/#465 OPEN · **#545 OPEN** (A-91+A-92) · **#548 OPEN** (A-93) · **#550 OPEN** (A-94) | iter 261 — `35668e4` (PR #550: A-94 analytics-dashboard + verify-professional auth hardening; 11 tests); CI pending. iter 260 — `e44a597` (PR #548: A-93); CI pending. iter 259 — `acd61c4` (PR #545); CI pending. | A-91+A-92 in-progress (#545). A-93 in-progress (#548). A-94 in-progress (#550). Remaining A: A-05 remaining ops batches · A-DISC-20260504-01/02 (admin marketplace broken notify). |
...
| A-DISC-20260504-01 | pending | `app/admin/marketplace/intelligence/page.tsx:620` — same broken broker_notifications pattern as A-92: direct `supabase.from("broker_notifications").insert(...)` from a client component using the browser (anon) client. Fails silently due to deny-all RLS. Fix: call `/api/admin/marketplace/campaign-notify` (created in A-92) instead. | 1 | Discovered 2026-05-04 during iter 259 Phase 6.5 sweep of A-91/A-92 adjacent files. Policy: same as A-92. |
| A-DISC-20260504-02 | pending | `app/admin/marketplace/support/page.tsx:124,157` — same broken pattern at two call sites. Fix: call `/api/admin/marketplace/campaign-notify` route. | 1 | Discovered 2026-05-04 during iter 259 Phase 6.5 sweep. Policy: same as A-92. |
