...
| --- | --- | --- | --- | --- |
| A | `claude/audit-remediation/a-03-batch-5-revenue-products` (#449) · `a-05-batch1-agent-ops-rls` (#451) · `a-05-batch2-ops-rls` (#452) · `a-05-batch3-crm-rls` (#453) · `a-disc-finance-monthly-view` (#454) | all prior PRs MERGED · #449 OPEN · #451 OPEN · #452 OPEN · #453 OPEN · #454 OPEN | iter 202 — `4ac575c` (PR #454: A-DISC-20260501-01 — CREATE OR REPLACE VIEW finance_monthly_summary aggregating finance_transactions by month); CI pending | A-01 done (PR #308). A-02 complete (batches 1-6 done). A-03 batches 1-5 done (#351/#401/#413/#415/#417/#449). A-04 done (PR #399). A-05 batches 1-3 in-progress (#451/#452/#453). A-DISC-20260501-01 done (PR #454). A-06 batch 1 done (PR #412). A-06 ~2 batches pending. A-07 false-positive (covered by I-02, PR #353). |
