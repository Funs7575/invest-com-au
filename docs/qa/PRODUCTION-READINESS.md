...
- Expert / team-admin / platform-admin click-testing still needs role-seeding (a `professionals` row / team membership / `ADMIN_EMAILS`) — more invasive; those roles remain covered by the security + journey code-reviews (AJ-1..9).
