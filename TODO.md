...
- [ ] Calibrate agent cost budgets after first month of real Claude API usage; current budgets in `.claude/agents/*.md` are estimates (00: AUD $120, 01: $180, 02: $350, 03: $400, 04: $220 = $1,270/mo for agents 00–04; 05: $200, 06: $100, 07: $180, 08: $150, 09: $120 = $750/mo for agents 05–09). Revisit after 30 days of telemetry from `agent_logs` cost aggregation. Surfaced 2026-04-21 during agent spec drafting (sessions 1–2).
