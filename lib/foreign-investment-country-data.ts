...
export const UK_CONFIG: CountryConfig = {
  ...
  advisorAnchor: {
    ...
    ctaHref: "/advisors/international-tax-specialists?specialty=UK%20Pension%20Transfer&country=uk",
    theme: "dark",
  },
...
export const US_CONFIG: CountryConfig = {
  ...
  advisorAnchor: {
    ...
    ctaHref: "/advisors/international-tax-specialists?specialty=FATCA-Aware%20US%20Expat%20Planning&country=us",
    theme: "light",
  },
...
export const CN_CONFIG: CountryConfig = {
  ...
  defaultActions: [
    ...
    { emoji: "👤", label: "Find a Mandarin-speaking advisor", sublabel: "Cross-border tax + FIRB + capital structuring", href: "/find-advisor?specialty=FIRB+Property+%28Non-Resident%29" },
  ],
  homepageListingFilters: {
    verticals: ["commercial-property", "buy-business", "funds"],
    firb: false,
  ...
  advisorAnchor: {
    ...
    ctaHref: "/advisors/international-tax-specialists?country=cn",
    theme: "light",
  },
...
export const IN_CONFIG: CountryConfig = {
  ...
  advisorAnchor: {
    ...
    ctaHref: "/advisors/international-tax-specialists?specialty=DASP%20Processing&country=in",
    theme: "light",
  },
...
export const HK_CONFIG: CountryConfig = {
  ...
  defaultActions: [
    ...
    { emoji: "👤", label: "Find an HK-AU advisor", sublabel: "Cross-border tax + AU residency + FIRB", href: "/find-advisor?specialty=FIRB+Property+%28Non-Resident%29" },
  ],
  ...
  advisorAnchor: {
    ...
    ctaLabel: "Find an Advisor",
    ctaHref: "/advisors/international-tax-specialists?country=hk",
    theme: "light",
  },
...
export const SG_CONFIG: CountryConfig = {
  ...
  defaultActions: [
    ...
    { emoji: "👤", label: "Find an SG-AU specialist", sublabel: "Multilingual cross-border tax + FIRB advisors", href: "/find-advisor?specialty=FIRB+Property+%28Non-Resident%29" },
  ],
  homepageListingFilters: {
  ...
  advisorAnchor: {
    ...
    ctaLabel: "Find an Advisor",
    ctaHref: "/advisors/international-tax-specialists?country=sg",
    theme: "light",
  },
...
export const NZ_CONFIG: CountryConfig = {
  ...
  advisorAnchor: {
    ...
    ctaLabel: "Find a Tax Specialist",
    ctaHref: "/advisors/international-tax-specialists?country=nz",
    theme: "light",
  },
...
export const JP_CONFIG: CountryConfig = {
  ...
  defaultActions: [
    ...
    { emoji: "👤", label: "Find a Japan-AU tax specialist", sublabel: "Inheritance tax exposure + DTA optimisation", href: "/find-advisor?specialty=FIRB+Property+%28Non-Resident%29" },
  ],
  homepageListingFilters: {
    verticals: ["funds", "commercial-property", "buy-business"],
    firb: false,
  ...
  advisorAnchor: {
    ...
    ctaLabel: "Find a Tax Specialist",
    ctaHref: "/advisors/international-tax-specialists?country=jp",
    theme: "light",
  },
...
export const KR_CONFIG: CountryConfig = {
  ...
  defaultActions: [
    ...
    { emoji: "👤", label: "Find a Korea-AU tax specialist", sublabel: "KAFTA, exit tax, DTA optimisation", href: "/find-advisor?specialty=FIRB+Property+%28Non-Resident%29" },
  ],
  homepageListingFilters: {
    verticals: ["funds", "commercial-property", "buy-business"],
    firb: false,
  ...
  advisorAnchor: {
    ...
    ctaLabel: "Find a Tax Specialist",
    ctaHref: "/advisors/international-tax-specialists?country=kr",
    theme: "light",
  },
...
export const MY_CONFIG: CountryConfig = {
  ...
  defaultActions: [
    ...
    { emoji: "👤", label: "Find a Malaysia-AU specialist", sublabel: "Cross-border tax + Labuan structuring", href: "/find-advisor?specialty=FIRB+Property+%28Non-Resident%29" },
  ],
  homepageListingFilters: {
    verticals: ["commercial-property", "buy-business", "funds"],
    firb: false,
  ...
  advisorAnchor: {
    ...
    ctaLabel: "Find a Tax Specialist",
    ctaHref: "/advisors/international-tax-specialists?country=my",
    theme: "light",
  },
...
export const AE_CONFIG: CountryConfig = {
  ...
  defaultActions: [
    ...
    { emoji: "👤", label: "Find a UAE-AU specialist", sublabel: "No-DTA structuring + Arabic-speaking advisors", href: "/find-advisor?specialty=FIRB+Property+%28Non-Resident%29" },
  ],
  homepageListingFilters: {
    verticals: ["commercial-property", "buy-business", "funds"],
    firb: false,
  ...
  advisorAnchor: {
    ...
    ctaLabel: "Find an Advisor",
    ctaHref: "/advisors/migration-agents?country=ae",
    theme: "light",
  },
...
export const SA_CONFIG: CountryConfig = {
  ...
  defaultActions: [
    ...
    { emoji: "👤", label: "Find a Saudi-AU specialist", sublabel: "No-DTA structuring + Islamic finance + Arabic-speaking advisors", href: "/find-advisor?specialty=FIRB+Property+%28Non-Resident%29" },
  ],
  homepageListingFilters: {
  ...
  advisorAnchor: {
    ...
    ctaLabel: "Find a Tax Specialist",
    ctaHref: "/advisors/migration-agents?country=sa",
    theme: "light",
  },
