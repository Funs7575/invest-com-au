...
// eslint-disable-next-line no-restricted-imports -- fee_index_snapshots has no anon/auth RLS policy; service-role is required (see 20260521_d1_fee_index_snapshots.sql)
