...
// Step 3: Sub-question (branches per goal — grow / income / crypto / trade /
//         automate / super / property / royalties / alt_assets / pre_ipo /
//         help / browse / listing-owner)
...
export const FALLBACK_QUESTIONS: QuestionDef[] = [
  ...
  },
  {
    ...
    step: 3,
    kind: "select",
    prompt: "How do you want to start growing your money?",
    subtitle: null,
    options: [
  ...
  },
  {
    ...
    step: 3,
    kind: "select",
    prompt: "Where do you want your income to come from?",
    subtitle: null,
    options: [
  ...
  },
  {
    ...
    step: 3,
    kind: "select",
    prompt: "How hands-off do you want to be?",
    subtitle: null,
    options: [
    ...
    shown_if: { intent: ["automate"] },
    maps_to: "automate_sub",
    risk_weight: 0,
    mode: "both",
    enabled: true,
    sort_order: 30,
  },
  {
    ...
    step: 3,
    kind: "select",
    prompt: "Which kind of royalty or income asset?",
    subtitle: null,
    options: [
    ...
    shown_if: { intent: ["royalties"] },
    maps_to: "royalties_sub",
    risk_weight: 0,
    mode: "both",
    enabled: true,
    sort_order: 30,
  ...
  // ─── Step 6: Budget ───
  // ── Decision Engine P3: the signals the advisor engine needs (state /
  // country / visa). Shown only where they matter: state for help-shaped
  // domestic plans, country+visa for overseas/expat. The engine degrades
  // gracefully when skipped ("any" / not_sure are treated as no-signal).
  {
    id: -135,
    slug: "location_state",
    step: 5,
    ...
    subtitle: "Helps us match professionals licensed and experienced in your state.",
    options: [
    ...
    shown_if: { starting_point: ["australia"], help_preference: ["individual", "firm", "expert_team", "investor_brief", "not_sure"] },
    maps_to: "location_state",
    risk_weight: 0,
    mode: "both",
    enabled: true,
    sort_order: 42,
  ...
  {
    id: -136,
    slug: "country_of_residence",
    step: 5,
    kind: "select",
    prompt: "Which country are you based in?",
    subtitle: "We match professionals who work with investors from your country.",
    options: [
    ...
    shown_if: { starting_point: ["overseas", "expat"] },
    maps_to: "country_of_residence",
    risk_weight: 0,
    mode: "both",
    enabled: true,
    sort_order: 44,
  },
  {
    ...
    step: 5,
    kind: "select",
    prompt: "What's your relationship with Australia?",
    subtitle: "Visa status changes which specialists fit (e.g. departing-resident super).",
    options: [
    ...
    shown_if: { starting_point: ["overseas"] },
    maps_to: "visa_status",
    risk_weight: 0,
    mode: "both",
    enabled: true,
