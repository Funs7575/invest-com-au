...
/**
 * Registry keyed by hubSlug. Lets a Server Component pass a *serialisable*
 * `configKey` string to <HubOnboardingShell> (a Client Component) instead of
 * the config object — the object carries a non-serialisable `evaluate`
 * function, which crashes the RSC render (React #419) if passed as a prop.
 */
export const HUB_ONBOARDING_CONFIGS: Record<string, HubOnboardingConfig> = {
  [SMSF_ONBOARDING_CONFIG.hubSlug]: SMSF_ONBOARDING_CONFIG,
  [DIVIDENDS_ONBOARDING_CONFIG.hubSlug]: DIVIDENDS_ONBOARDING_CONFIG,
  [WHOLESALE_ONBOARDING_CONFIG.hubSlug]: WHOLESALE_ONBOARDING_CONFIG,
  [PROPERTY_ONBOARDING_CONFIG.hubSlug]: PROPERTY_ONBOARDING_CONFIG,
  [ETF_ONBOARDING_CONFIG.hubSlug]: ETF_ONBOARDING_CONFIG,
  [INSURANCE_ONBOARDING_CONFIG.hubSlug]: INSURANCE_ONBOARDING_CONFIG,
  [NEGATIVE_GEARING_ONBOARDING_CONFIG.hubSlug]: NEGATIVE_GEARING_ONBOARDING_CONFIG,
  [SUPER_ONBOARDING_CONFIG.hubSlug]: SUPER_ONBOARDING_CONFIG,
  [CRYPTO_ONBOARDING_CONFIG.hubSlug]: CRYPTO_ONBOARDING_CONFIG,
  [LUMP_SUM_ONBOARDING_CONFIG.hubSlug]: LUMP_SUM_ONBOARDING_CONFIG,
  [FOREIGN_INVESTMENT_ONBOARDING_CONFIG.hubSlug]: FOREIGN_INVESTMENT_ONBOARDING_CONFIG,
  [SELL_BUSINESS_ONBOARDING_CONFIG.hubSlug]: SELL_BUSINESS_ONBOARDING_CONFIG,
  [HALAL_INVESTING_ONBOARDING_CONFIG.hubSlug]: HALAL_INVESTING_ONBOARDING_CONFIG,
  [FIRST_HOME_BUYER_ONBOARDING_CONFIG.hubSlug]: FIRST_HOME_BUYER_ONBOARDING_CONFIG,
};
