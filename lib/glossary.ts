...
export const GLOSSARY_ENTRIES: GlossaryEntry[] = [
  ...
  // ─── DB parity (synced from supabase/migrations/20260419_glossary_terms.sql) ───
  // These terms already live in public.glossary_terms (the runtime source); mirrored
  // here so JargonTooltip + the build-time fallback cover the full ~200-term set.
  {
    term: "Alpha",
    slug: "alpha",
    definition:
