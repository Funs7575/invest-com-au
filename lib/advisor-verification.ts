...
export const VERIFICATION_CONFIGS: Record<ProfessionalType, VerificationConfig> = {
  ...
  classic_car_specialist: {
    type: "classic_car_specialist",
    label: "Classic Car Specialist",
    primaryLicence: {
      code: "ABN",
      name: "Australian Business Number",
      regulator: "Australian Business Register",
      regulatorShort: "ABR",
      verifyUrl: "https://abr.business.gov.au/",
      verifyLabel: "Verify on ABN Lookup",
      mandatory: true,
      field: "abn",
      description: "Classic-car specialists are not licensed as financial advisers (cars are not financial products under the Corporations Act 2001). The minimum verifiable credential is a current ABN registered for the relevant business activity.",
    },
    additionalLicences: [],
    qualifications: [
      "Documented experience in classic and collectible vehicle valuation, restoration, or auction representation",
      "Familiarity with HAGI / Hagerty index methodology and Australian muscle-car provenance",
      "Working knowledge of the SISA s62A in-house asset / personal-use rules where SMSF clients are involved",
    ],
    associations: [
      { name: "Australian Auto Auctioneers & Dealers Association", acronym: "AADA", url: "https://www.aada.asn.au" },
      { name: "Federation of Veteran, Vintage & Classic Vehicle Clubs", acronym: "AHMF", url: "https://www.ahmf.org.au" },
    ],
    insurance: "Professional Indemnity Insurance — strongly recommended; not federally mandated. Specialist agreed-value vehicle insurance is industry standard for stocked inventory.",
    edr: "No federal EDR scheme applies. Disputes typically handled through state Fair Trading consumer-protection regimes or general civil-court action.",
    cpd: "No mandatory CPD regime. Industry bodies offer voluntary upskilling on authentication, provenance research, and auction practice.",
    disclosure: "Classic cars are not financial products under the Corporations Act 2001 — no AFSL is required for purchase advice. However, advice that touches on SMSF compliance (cars in super are restricted under SISA s62A — must be insured, stored independently of members, not personally used) or capital-gains-tax treatment may require an AFSL holder or a registered tax agent. Verify the specialist's ABN on ABN Lookup and ask explicitly about any SMSF or tax advisory services before engaging.",
  },

  luxury_asset_broker: {
    type: "luxury_asset_broker",
    label: "Luxury Asset Broker",
    primaryLicence: {
      code: "ABN",
      name: "Australian Business Number",
      regulator: "Australian Business Register",
      ...
      mandatory: true,
      field: "abn",
      description: "Luxury-asset brokers are not licensed as financial advisers (watches, jewellery and similar collectibles are not financial products under the Corporations Act 2001). The minimum verifiable credential is a current ABN registered for the relevant business activity.",
    },
    additionalLicences: [],
    qualifications: [
      "Documented experience in investment-grade horology (Rolex, Patek Philippe, Audemars Piguet) or comparable luxury-asset segments",
      "Authentication training or recognised dealer accreditation (e.g. WatchCharts, Chrono24 Trusted Seller, GIA / FGAA gemmology for jewellery)",
      "Working knowledge of the SISA s62A in-house asset / personal-use rules where SMSF clients are involved",
    ],
    associations: [
      { name: "Jewellers Association of Australia", acronym: "JAA", url: "https://www.jaa.com.au" },
      { name: "Gemmological Association of Australia", acronym: "GAA", url: "https://www.gem.org.au" },
    ],
    insurance: "Professional Indemnity Insurance — strongly recommended; not federally mandated. Stock-in-transit and specie insurance is industry standard for inventory and consignment.",
    edr: "No federal EDR scheme applies. Disputes typically handled through state Fair Trading consumer-protection regimes or general civil-court action.",
    cpd: "No mandatory CPD regime. Recognised authentication training (WatchCharts, GIA, FGAA) is the de-facto credentialling pathway.",
    disclosure: "Watches, jewellery and luxury goods are not financial products under the Corporations Act 2001 — no AFSL is required for purchase advice. However, advice on tokenised or fractional luxury-asset platforms may fall under the managed investment scheme regime and require an AFSL. SMSF holdings of these assets are restricted under SISA s62A and require independent storage, insurance, and no personal use. Verify the broker's ABN on ABN Lookup and ask explicitly about platform-related and SMSF advisory before engaging.",
  },
  ...
  wine_advisor: {
    ...
    primaryLicence: {
      ...
      mandatory: true,
      field: "abn",
      description: "Wine advisors are not licensed as financial advisers (wine itself is not a financial product under the Corporations Act 2001). The minimum verifiable credential is a current ABN registered for the relevant business activity.",
    },
    additionalLicences: [],
    qualifications: [
      "WSET Diploma (Level 4), Court of Master Sommeliers Advanced Sommelier, or equivalent recognised wine credential",
      "Documented experience in fine-wine portfolio construction, cellaring, and Liv-ex index tracking",
      "Working knowledge of the SISA s62A rules where SMSF clients are considering wine collections in super",
    ],
    associations: [
      { name: "Wine Communicators of Australia", acronym: "WCA", url: "https://winecommunicators.com.au" },
      { name: "Wine & Spirit Education Trust", acronym: "WSET", url: "https://www.wsetglobal.com" },
    ],
    insurance: "Professional Indemnity Insurance — strongly recommended; not federally mandated. Bonded-warehouse and specie insurance is industry standard for stored inventory.",
    edr: "No federal EDR scheme applies. Disputes typically handled through state Fair Trading consumer-protection regimes or general civil-court action.",
    cpd: "No mandatory CPD regime. WSET, Court of Master Sommeliers, and Wine Australia run voluntary upskilling.",
    disclosure: "Wine is not a financial product under the Corporations Act 2001 — no AFSL is required for direct-purchase advice. However, advice on fractional wine platforms (Vinovest, Cult Wines), wine funds, or wine-backed lending may fall under the managed investment scheme regime and require an AFSL. SMSF wine holdings are restricted under SISA s62A — must be stored independently, fully insured, and not consumed by members. Verify the advisor's ABN on ABN Lookup and ask explicitly about platform and SMSF advice before engaging.",
  },
  ...
  art_advisor: {
    ...
    primaryLicence: {
      ...
      mandatory: true,
      field: "abn",
      description: "Art advisors are not licensed as financial advisers (artworks are not financial products under the Corporations Act 2001). The minimum verifiable credential is a current ABN registered for the relevant business activity.",
    },
    additionalLicences: [],
    qualifications: [
      "Tertiary qualification in art history, fine arts, or curatorial practice (or equivalent gallery / auction-house experience)",
      "Documented authentication, provenance-research, and condition-reporting practice",
      "Working knowledge of the SISA s62A rules where SMSF clients are considering art in super, and the Cultural Gifts Program where applicable",
    ],
    associations: [
      { name: "Art Consulting Association of Australia", acronym: "ACAA", url: "https://www.acaa.org.au" },
      { name: "Australian Commercial Galleries Association", acronym: "ACGA", url: "https://www.acga.com.au" },
    ],
    insurance: "Professional Indemnity Insurance — strongly recommended; not federally mandated. Specie / fine-art insurance is industry standard for inventory and transit.",
    edr: "No federal EDR scheme applies. Disputes typically handled through state Fair Trading consumer-protection regimes or general civil-court action.",
    cpd: "No mandatory CPD regime. ACAA, ICOM Australia and university programmes run voluntary upskilling.",
    disclosure: "Artworks are not financial products under the Corporations Act 2001 — no AFSL is required for direct-purchase advice. However, advice on fractional art platforms (Masterworks, Maverix), art funds, or art-backed lending may fall under the managed investment scheme regime and require an AFSL. SMSF art holdings are restricted under SISA s62A — must be stored independently of members (not displayed in members' homes or workplaces), fully insured within 7 days of acquisition, and not leased to related parties. Verify the advisor's ABN on ABN Lookup and ask explicitly about platform and SMSF advice before engaging.",
  },

  royalty_broker: {
    type: "royalty_broker",
    label: "Royalty Broker",
    primaryLicence: {
      code: "AFSL",
      name: "Australian Financial Services Licence",
      regulator: "Australian Securities and Investments Commission",
      ...
      mandatory: false,
      field: "afsl_number",
      description: "Royalty advisory sits in a regulatory grey zone. Direct music-copyright assignment advice is generally not an AFSL activity, but most royalty STREAMS that pay periodic returns to passive investors (mining, petroleum, music-catalogue funds, IP-pool funds) constitute a managed investment scheme under Corporations Act s9 and require an AFSL. Verify on the ASIC Register.",
    },
    additionalLicences: [],
    qualifications: [
      "Documented experience in royalty deal structuring (music catalogue, mining royalty streams, petroleum overriding royalties, or IP pools)",
      "Working knowledge of s708 sophisticated- and wholesale-investor exemptions, since most royalty placements rely on them",
      "For music: APRA AMCOS / PPCA membership awareness; for mining: NSR vs gross-revenue royalty mechanics; for IP: patent-pool and licensing-fund mechanics",
    ],
    associations: [
      { name: "Australasian Performing Right Association", acronym: "APRA AMCOS", url: "https://www.apraamcos.com.au" },
      { name: "Australian Resources & Energy Employer Association", acronym: "AREEA", url: "https://www.areea.com.au" },
    ],
    insurance: "Professional Indemnity Insurance — mandatory under any AFSL conditions; otherwise strongly recommended.",
    edr: "If acting under an AFSL, must be a member of AFCA. Otherwise civil court / s708 disclosure-disputes apply.",
    cpd: "If holding or operating under an AFSL, ASIC's 40-hour annual CPD requirement applies. Otherwise voluntary.",
    disclosure: "Most royalty streams paid to passive investors are managed investment schemes under Corporations Act s9 and require an AFSL — verify the broker's licence number on the ASIC Register before any commitment. Royalty placements typically rely on s708 sophisticated-/wholesale-investor carve-outs, meaning retail investors may not be eligible. Royalty income is assessable income (not capital gain) for ATO purposes, with PAYG-withholding and characterisation rules that vary materially by underlying asset (music vs mining vs IP). Engage a tax agent in parallel.",
  },
};
