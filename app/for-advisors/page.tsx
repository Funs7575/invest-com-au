...
const FOR_ADVISORS_FAQ_LD = faqJsonLd([
  {
    q: "How does Invest.com.au generate leads for financial advisors?",
    a: "Invest.com.au attracts Australian investors who are actively comparing platforms and researching financial products. When an investor views your profile and submits an enquiry — providing their name, email, and often a phone number and message — that becomes a lead exclusively allocated to you. Investors can also book a free consultation directly from your profile via your Calendly or Cal.com link.",
  },
  {
    q: "What types of advisors can list on Invest.com.au?",
    a: "Invest.com.au accepts Financial Planners (AFP/CFP), SMSF Specialists and Accountants, Tax Agents and Tax Planners, Mortgage Brokers, Property Investment Advisors, Retirement Planning Specialists, Estate Planning Professionals, and Insurance Advisors. All advisors must hold a current AFSL, be an authorised representative, or be registered with a relevant body such as the TPB or ASIC.",
  },
  {
    q: "How much does it cost to list as a financial advisor?",
    a: "Creating your profile and receiving your first 3 leads is completely free — no credit card or setup fee required. After your 3 free leads, you top up with a A$150 prepaid credit balance. Each subsequent lead costs A$39 and deducts from your balance. There are no monthly fees, no lock-in contracts, and no minimum spend.",
  },
  {
    q: "What compliance requirements apply to advisors listed on Invest.com.au?",
    a: "All listed advisors must hold a current Australian Financial Services Licence (AFSL), be an authorised representative of an AFSL holder, or be registered with a relevant professional body such as the Tax Practitioners Board (TPB) or ASIC. We verify your registration or licence number during the application process before publishing your profile.",
  },
  {
    q: "How does the lead routing and matching system work?",
    a: "Leads are allocated directly and exclusively to the advisor whose profile the investor enquires through. We do not distribute or share leads across multiple advisors. Each lead arrives with the investor's contact details and is scored 0–100 based on engagement signals so you can prioritise your follow-up. You manage and track all leads in your advisor dashboard.",
  },
]);
...
export default async function ForAdvisorsPage() {
  ...
  return (
    <>
      {FOR_ADVISORS_FAQ_LD && <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(FOR_ADVISORS_FAQ_LD) }} />}
