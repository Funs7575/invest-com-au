...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: `/api/og?title=${encodeURIComponent("Foreign Property Investment Australia — Chinese Guide")}&sub=${encodeURIComponent("FIRB · Residential · Stamp Duty · " + CURRENT_YEAR)}`, width: 1200, height: 630 }],
    },
  };
}
