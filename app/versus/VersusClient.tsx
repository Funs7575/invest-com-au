          ...
          <>
            ...
            <ScrollReveal animation="scroll-stagger-children" className="grid grid-cols-2 md:grid-cols-2 gap-2.5 md:gap-4 mb-3 md:mb-4">
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-xl md:rounded-2xl p-3.5 md:p-6">
                ...
                <Link href="/get-matched" className="inline-block px-3 py-2 md:px-5 md:py-2.5 bg-amber-500 text-slate-900 font-semibold rounded-lg md:rounded-xl hover:bg-amber-600 transition-colors text-[0.69rem] md:text-sm mt-1.5 md:mt-0">
                  Take the Quiz →
                </Link>
              </div>
            </ScrollReveal>
