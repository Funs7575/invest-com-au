              ...
              {emailGated && !emailSubmitted && ranked.length > 3 && (
                <div className="px-4 py-6 bg-gradient-to-b from-white to-slate-50 text-center border-t border-slate-100">
                  ...
                  <div className="flex gap-2 max-w-xs mx-auto">
                    <input type="email" autoComplete="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="your@email.com" aria-label="Email address" className="flex-1 px-3 py-2 text-sm border border-slate-200 rounded-lg" />
