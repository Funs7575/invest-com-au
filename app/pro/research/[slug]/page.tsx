    ...
    <div className="mx-auto max-w-3xl px-4 py-10 md:py-14">
      ...
      {isPro ? (
        <article
          ...
          // eslint-disable-next-line invest/no-unsafe-inner-html -- body_html is admin-authored only (pro_research_reports has service-role-only write RLS) and re-sanitised here via lib/sanitize-html.ts as defence-in-depth.
