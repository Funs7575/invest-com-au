...
export default function BestCategoryError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="min-h-[50vh] flex items-center justify-center px-4 py-12">
      <div className="text-center max-w-md">
        <div className="text-4xl mb-4">🏆</div>
        <h1 className="text-xl font-bold text-slate-900 mb-2">Page temporarily unavailable</h1>
        <p className="text-sm text-slate-500 mb-6">
          Something went wrong loading this category page. Please try again or browse our platform comparison.
        </p>
