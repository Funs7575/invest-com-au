          ...
          pendingDelete ? (
            <div className="bg-red-50 border border-red-200 rounded-xl p-4">
              ...
              <p className="text-xs text-red-800 mb-3">
                ...
                Bookmarks, saved comparisons, quiz history, and forum posts cannot be recovered.
              </p>
              <div className="flex items-center gap-2">
                ...
                >
                  {deleteBusy ? "Scheduling…" : "Yes, schedule deletion"}
                </button>
                <button
                  type="button"
                  onClick={() => setPendingDelete(false)}
                  className="px-4 py-2 rounded-lg bg-white border border-slate-300 text-slate-700 font-semibold text-sm hover:bg-slate-50"
                >
                  Cancel
                </button>
              </div>
