    ...
    <div className="py-12">
      <div className="container-custom max-w-2xl">
        ...
        {subscription ? (
          ...
          <div className="bg-gradient-to-br from-green-50 to-amber-50 border border-green-200 rounded-xl p-6 mb-4 text-center">
            ...
            <Link
              href="/pro"
              className="inline-block px-6 py-2.5 bg-green-700 text-white text-sm font-semibold rounded-xl hover:bg-green-800 transition-colors"
            >
              View Plans
            </Link>
          </div>
