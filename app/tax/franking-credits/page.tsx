...
export const metadata: Metadata = {
  ...
  description: `Franking credits in Australia: how dividend imputation works, benefit by tax bracket, cash refunds for low earners, and maximising franking in super. ${UPDATED_LABEL}.`,
  openGraph: {
