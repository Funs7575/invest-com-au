...
export default function AltAssetsPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
            ...
            <table className="w-full text-sm" aria-label="Alternative asset classes at a glance — minimum entry, liquidity and Australian tax treatment">
              <thead>
                <tr className="bg-slate-900">
                  ...
                  <th scope="col" className="text-left px-3 py-3 text-xs font-bold text-white uppercase tracking-wide">Min. entry</th>
                  <th scope="col" className="text-left px-3 py-3 text-xs font-bold text-white uppercase tracking-wide">Liquidity</th>
                  <th scope="col" className="text-left px-4 py-3 text-xs font-bold text-white uppercase tracking-wide">AU tax treatment</th>
                </tr>
              </thead>
      ...
      <HubAdvisorCTA
        heading="Get a financial adviser who understands alternative assets"
        subheading="Alternative assets are illiquid, complex, and taxed differently to shares. A specialist adviser can review whether they fit your portfolio allocation and tax situation."
        intent={{ need: "planning", context: ["alternative_assets", "portfolio_diversification"] }}
        source="alt_assets"
        ctaLabel="Find an investment specialist"
