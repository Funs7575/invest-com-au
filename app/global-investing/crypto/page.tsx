...
export const metadata: Metadata = {
  ...
  description: `Binance, Kraken, Bybit, and KuCoin for Australian investors — AUSTRAC status, AUD on-ramp options, fees, and Australian CGT on crypto gains. Compare global vs domestic exchanges. ${UPDATED_LABEL}.`,
  openGraph: {
