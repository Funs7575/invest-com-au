  ...
  return (
    <div className="max-w-xl">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 mb-5">
        ...
        <div className="bg-slate-50 rounded-lg p-3 mb-4 text-xs text-slate-600 leading-relaxed">
          <strong className="text-slate-800">How to set up:</strong>{" "}
          In Slack, go to <span className="font-mono bg-white px-1 rounded border border-slate-200">Apps → Incoming WebHooks → Add to Slack</span>, choose a channel, then copy the Webhook URL here.{" "}
          <a href="https://api.slack.com/messaging/webhooks" target="_blank" rel="noopener noreferrer" className="text-violet-600 hover:underline">Slack docs ↗</a>
        </div>
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 text-sm border border-slate-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-500 font-mono"
          />
          <button
