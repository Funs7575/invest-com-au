export default function Loading() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 animate-pulse" aria-busy="true" aria-label="Loading sign up">
      <div className="w-full max-w-sm border border-slate-100 rounded-2xl p-8 space-y-5">
        ...
        <div className="h-4 w-44 bg-slate-100 rounded mx-auto" />
      </div>
    </div>
  );
}
