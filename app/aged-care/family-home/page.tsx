...
export const metadata: Metadata = {
  ...
  description: `How the family home is treated in aged care: the 2-year exemption, when to sell, CGT on sale, using proceeds for a RAD, and estate planning. ${UPDATED_LABEL}.`,
  openGraph: {
