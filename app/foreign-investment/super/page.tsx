      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-10 md:py-14">
        <div className="container-custom">
          <nav className="text-xs text-slate-400 mb-5 flex items-center gap-1.5 flex-wrap">
            ...
            <span>/</span>
            <span className="text-slate-300">Superannuation & DASP</span>
          </nav>
          <div className="max-w-2xl">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold leading-[1.1] mb-3 tracking-tight">
              Superannuation for{" "}
              <span className="text-amber-400">Foreign Workers</span>
              <br />— DASP Guide
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                href="#how-to-claim"
                className="px-6 py-3 bg-amber-500 hover:bg-amber-400 text-white font-bold rounded-xl text-sm text-center transition-colors"
              >
