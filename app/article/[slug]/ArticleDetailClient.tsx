    ...
    <div className="flex items-center gap-4 p-4 border border-slate-100 rounded-lg hover:bg-slate-50 transition-colors">
      ...
      <div className="flex-1 min-w-0">
        <a
          ...
          className="font-bold text-sm hover:text-amber transition-colors"
        >
          {broker.name}
        </a>
        {broker.tagline && (
      ...
      <a
        ...
        className="shrink-0 px-4 py-2 bg-amber text-white text-xs font-bold rounded-lg hover:bg-amber-600 transition-colors"
      >
