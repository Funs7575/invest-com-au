      ...
      <div className="container-custom max-w-3xl py-6 md:py-10">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 md:p-8 shadow-sm mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="flex gap-1.5 mt-2">
                  {[6, 8, 10, 12, 14].map(v => (
                    <button key={v} onClick={() => setConsolidationRate(v)} className={`text-xs px-2.5 py-1.5 rounded-full min-h-9 font-semibold transition-all ${consolidationRate === v ? "bg-amber-600 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"}`}>
                      {v}%
                    </button>
                  ))}
                </div>
          ...
          <button
            ...
            className="w-full mt-6 px-6 py-3.5 bg-amber-600 text-slate-900 text-base font-bold rounded-xl hover:bg-amber-700 transition-all shadow-lg hover:shadow-xl"
          >
