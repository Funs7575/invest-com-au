...
export const metadata: Metadata = {
  ...
  description: `Australian tax-loss harvesting: crystallise capital losses before 30 June to cut CGT. Wash sale rules, worked examples, and checklist. ${UPDATED_LABEL}.`,
  openGraph: {
