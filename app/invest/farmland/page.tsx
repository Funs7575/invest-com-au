...
export default function FarmlandPage() {
  ...
  return (
    <div>
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-green-900 via-slate-900 to-slate-900 text-white py-14 md:py-20">
        <div className="container-custom">
          <nav className="flex items-center gap-1.5 text-xs text-slate-400 mb-6" aria-label="Breadcrumb">
            ...
            <Icon name="chevron-right" size={12} className="text-slate-600" />
            <span className="text-slate-300">Farmland</span>
          </nav>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={s.label} className="bg-white border border-green-100 rounded-xl p-4 text-center">
      ...
      <section className="py-14 bg-slate-900 text-white">
        <div className="container-custom text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-4">Browse Farmland Listings</h2>
