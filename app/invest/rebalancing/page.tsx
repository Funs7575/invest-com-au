...
export const metadata: Metadata = {
  ...
  description: `Portfolio rebalancing in Australia: how drift happens, the 5%/25% rule, tax-efficient strategies, super rebalancing, and a worked example. ${UPDATED_LABEL}.`,
  openGraph: {
