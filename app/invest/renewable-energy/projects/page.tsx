...
import EnergyListingsClient from "./EnergyListingsClient";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${SITE_URL}/invest/renewable-energy/projects` },
    openGraph: {
      title: `Renewable Energy Projects Australia — ${countLabel}Investment Opportunities`,
      url: `${SITE_URL}/invest/renewable-energy/projects`,
    },
  };
}
...
export default async function EnergyProjectsPage() {
  ...
  return (
    <>
      ...
      />
      <EnergyListingsClient listings={listings} />
    </>
  );
}
