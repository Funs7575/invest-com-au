    ...
    <div>
      ...
      <section className="relative bg-white border-b border-slate-100 overflow-hidden py-8 md:py-12">
        <div className="container-custom">
          <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-slate-500 mb-6">
            ...
            <span className="text-slate-300">/</span>
            <span className="text-slate-900 font-medium">Dividend Investing</span>
          </nav>
      ...
      <section className="py-14 bg-slate-50">
        <div className="container-custom max-w-4xl">
          ...
          <p className="text-xs text-slate-500 mt-3">Yields are indicative and change with share prices and dividend announcements. Past dividends are not guaranteed.</p>
        </div>
      </section>
