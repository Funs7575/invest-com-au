    ...
    <div className="py-5 md:py-12">
      <div className="container-custom max-w-2xl">
                ...
                return (
                  <div key={i} className="flex items-center flex-1">
                    <div className="flex flex-col items-center">
                      ...
                      <span className={`text-[0.6rem] mt-1 font-medium hidden sm:block ${isCurrent ? "text-violet-700" : isDone ? "text-slate-500" : "text-slate-500"}`}>{s.label}</span>
                    </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 md:p-6">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                {isInviteFlow && <p className="text-[0.56rem] text-slate-500 mt-0.5">Email is fixed by your invitation.</p>}
              </div>
              <div>
            ...
            <div>
              ...
              <p className="text-[0.56rem] text-slate-500 mt-0.5">Comma-separated</p>
            </div>
          ...
          <p className="text-[0.52rem] text-slate-500 mt-1.5 text-center">
