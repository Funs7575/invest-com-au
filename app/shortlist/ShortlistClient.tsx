      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleShare}
            disabled={sharing}
            className="text-xs font-medium text-purple-600 hover:text-purple-800 transition-colors px-2 py-1 min-h-11 inline-flex items-center gap-1"
          >
          ...
          <button
            onClick={clear}
            className="text-xs text-red-500 hover:text-red-700 font-medium transition-colors px-2 py-1 min-h-11"
          >
            Clear All
          </button>
        </div>
      ...
      {shareUrl && (
        <div className="bg-purple-50 border border-purple-200 rounded-xl p-3 mb-3 flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-purple-600 text-white text-xs font-bold rounded-lg hover:bg-purple-700 transition-colors shrink-0 min-h-11"
          >
            ...
            <div className="flex items-center gap-2.5 md:gap-4">
              ...
              <div className="flex items-center gap-1.5 md:gap-2 shrink-0">
                ...
                <button
                  ...
                  className={`w-8 h-8 md:w-9 md:h-9 flex items-center justify-center rounded-lg transition-colors min-h-11 ${
                    notes[broker.slug]
                ...
                <button
                  ...
                  className="w-8 h-8 md:w-9 md:h-9 flex items-center justify-center rounded-lg text-slate-300 hover:text-red-500 hover:bg-red-50 transition-colors min-h-11"
            ...
            {editingNote === broker.slug && (
              <div className="mt-2 ml-[2.875rem] md:ml-14 flex items-center gap-2">
                <input
                  ...
                  autoFocus
                  className="flex-1 px-3 py-1.5 bg-white border border-slate-300 rounded-lg text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500/30 min-h-11"
                  maxLength={200}
                />
                <button
                  onClick={() => saveNote(broker.slug)}
                  className="px-3 py-1.5 bg-blue-600 text-white text-xs font-bold rounded-lg hover:bg-blue-700 transition-colors min-h-11"
                >
                  Save
                </button>
                <button
                  onClick={() => { setEditingNote(null); setNoteValue(""); }}
                  className="px-2 py-1.5 text-xs text-slate-500 hover:text-slate-700 transition-colors min-h-11"
                >
                  Cancel
                </button>
              </div>
