...
export async function generateMetadata(): Promise<Metadata> {
  const dict = getSubPageDict("tax", "ko");
  return {
    title: dict.meta.title,
    description: dict.meta.description,
    alternates: {
      canonical: `${SITE_URL}/ko/foreign-investment/tax`,
      languages: {
...
export default function KOTaxPage() {
  return <ForeignInvestmentSubPage locale="ko" slug="tax" />;
}
