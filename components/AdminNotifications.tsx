  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        className="relative p-2 text-slate-600 hover:text-slate-600 hover:bg-white rounded-lg border border-transparent hover:border-slate-200 transition-colors"
      ...
      >
        ...
        {badgeCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 flex items-center justify-center w-4.5 h-4.5 min-w-4.5 text-[0.6rem] font-bold text-white bg-red-500 rounded-full px-1">
            {badgeCount}
          </span>
        )}
      </button>
