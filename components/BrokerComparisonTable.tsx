              ...
              >
                ...
                <td className="px-5 py-4 text-right">
                  <a
                    ...
                    target="_blank"
                    rel={AFFILIATE_REL}
                    className="inline-block px-4 py-2 bg-amber-600 text-slate-900 text-xs font-bold rounded-lg hover:bg-amber-700 hover:scale-105 transition-all"
                  >
                    Go to Site &rarr;
                  </a>
                </td>
        ...
        {sorted.map((b, i) => (
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel={AFFILIATE_REL}
              className="block w-full text-center px-4 py-2.5 bg-amber-600 text-slate-900 text-sm font-bold rounded-lg hover:bg-amber-700 transition-colors"
            >
              Go to Site &rarr;
            </a>
          </div>
