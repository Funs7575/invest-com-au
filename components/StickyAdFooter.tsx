    ...
    >
      <div className="max-w-5xl mx-auto px-4 py-2 flex items-center gap-3">
        ...
        <a
          ...
          className="shrink-0 px-3 sm:px-4 py-1.5 bg-amber-500 text-slate-900 text-xs font-bold rounded-lg hover:bg-amber-600 transition-colors"
        >
          Learn More →
        </a>
        <button
          onClick={handleDismiss}
          className="shrink-0 p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center text-slate-500 hover:text-slate-600 transition-colors"
