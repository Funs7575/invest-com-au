...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { label: "Businesses for Sale", href: "/invest/listings?vertical=business", icon: "briefcase", color: "bg-slate-700" },
      { label: "Mining & Resources", href: "/invest/listings?vertical=mining", icon: "layers", color: "bg-amber-600" },
      { label: "Farmland", href: "/invest/listings?vertical=farmland", icon: "leaf", color: "bg-green-600" },
      { label: "Commercial Property", href: "/invest/listings?vertical=commercial_property", icon: "building", color: "bg-blue-600" },
      { label: "Alternatives", href: "/invest/listings?vertical=alternatives", icon: "gem", color: "bg-rose-600" },
