...
export default function PromoBadge({ broker }: { broker: Broker }) {
  ...
  return (
    <span className="relative group/promo inline-flex ml-1.5">
      <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 bg-amber-50 border border-amber-200 rounded-full text-[0.55rem] font-semibold text-amber-700 cursor-help whitespace-nowrap">
        Promo
      </span>
