...
const mobileNavSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Advisor Insights Feed", href: "/feed" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "R&D Tax Incentive", href: "/grants/rd-tax-incentive" },
      { name: "EMDG Export Grant", href: "/grants/emdg" },
      { name: "Industry Growth Program", href: "/grants/industry-growth-program" },
      { name: "Sell a Business", href: "/sell-business" },
      { name: "Business Valuation", href: "/sell-business/valuation" },
      { name: "Dividend Hub", href: "/dividends" },
      { name: "Franking Credits Calculator", href: "/dividends/calculator" },
      { name: "Negative Gearing", href: "/negative-gearing" },
      { name: "Lump-Sum Investing", href: "/lump-sum-investing" },
      { name: "Visa & Migration", href: "/visa-investment" },
...
const advisorsSidebar: MegaMenuSidebar = {
  ...
  links: [
    ...
    { label: "Advisor Insights Feed", href: "/feed" },
