...
export default memo(function DealCard({
  ...
  const msRemaining = expiryDate
    ? // eslint-disable-next-line react-hooks/purity -- render-time countdown vs wall clock; day/hour granularity tolerates render-to-render drift
        ...
        <div className="flex-1 min-w-0">
          ...
          {SHOW_RATINGS && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-[0.69rem] text-slate-500" aria-label={`Rated ${broker.rating} out of 5`}>{broker.rating}/5</span>
            </div>
          )}
        </div>
