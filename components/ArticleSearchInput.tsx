  ...
  return (
    <div className="relative mb-2 md:mb-4">
      ...
      <input
        ...
        className="w-full md:w-80 pl-9 md:pl-10 pr-3 md:pr-4 py-2.5 md:py-2.5 min-h-11 border border-slate-200 rounded-lg text-xs md:text-sm focus:outline-none focus:border-blue-700 focus:ring-1 focus:ring-blue-700/40"
