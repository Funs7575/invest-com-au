...
import { GET, maxDuration } from "@/app/api/cron/observability-retention/route";

const SECRET = "test-cron-secret-1234567890";

function req(headers: Record<string, string> = {}): NextRequest {
  return new Request("http://localhost/api/cron/observability-retention", { headers }) as unknown as NextRequest;
}
