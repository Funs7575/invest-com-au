...
vi.mock("@/lib/attribution-daily", () => ({
  rollupYesterdayAttribution: vi.fn(async () => ({
    date: "2026-05-19",
    channelCount: 0,
    totalTouches: 0,
    totalConversions: 0,
...
import { GET, runtime, maxDuration } from "@/app/api/cron/attribution-rollup/route";

const SECRET = "test-cron-secret-1234567890";
function req(headers: Record<string, string> = {}): NextRequest {
  return new Request("http://localhost/api/cron/attribution-rollup", { headers }) as unknown as NextRequest;
}
