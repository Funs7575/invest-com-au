...
import { GET, runtime, maxDuration } from "@/app/api/cron/automation-verdict-rollup/route";

const SECRET = "test-cron-secret-1234567890";
function req(headers: Record<string, string> = {}): NextRequest {
  return new Request("http://localhost/api/cron/automation-verdict-rollup", { headers }) as unknown as NextRequest;
}
